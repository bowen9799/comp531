...
export const FormValidation = ({ submit, validateDOB, validatePasswords, formStyle, currentUser }) => {
	let form
	let fields = {}
	...
	return (
		<form id="form" onSubmit={_submit} ref={(node) => form = node}  >
			<div className="form-group row">
				...
				{/*<!--Acc format: start with letters then any alphabetic char-->*/}
				{isRegister ? (
			...
			<div className="form-group row">
				...
				{/*<!--Email format: char + @ + char + . + 3 char, from W3 school
					 documentation-->*/}
				<div className="col-sm-8">
					<input
						id='inputEmail'
			...
			<div className="form-group row">
				...
				{/*<!--Not verifying date here, allowing future date because limiting 
					that means a lot of extra JS.-->*/}
				<div className="col-sm-8">
					{isRegister ? (
			...
			<div className="form-group row">
				<label className="col-sm-3 form-control-label text-right">
					Zipcode: (5 digits or 12345-1234)
					</label>
				<div className="col-sm-8">
					<input
						id='inputZipcode'
